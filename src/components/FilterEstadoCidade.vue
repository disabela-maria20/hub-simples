    ...
    <div>
        ...
        <div id="box-busca-programacao" class="box-busca-programacao">
            ...
            <div class="combos-busca">
                <select class="form-control" name="estado data-select" ref="estado" v-model="configs.filter_estado"
                    v-on:change="alt_estado()">
                    <option value="" disabled selected hidden>Estado</option>
                    <option v-for="(estado, index) in estados" :value="index" :key="index">{{ index }}</option>
                </select>

                <select class="form-control" name="cidade data-select" ref="cidade" v-model="configs.filter_cidade"
                    v-on:change="alt_cidade()">
            ...
            <div class="open" v-if="isOpen">
                ...
                <a href="http://">
                    <img src="@/assets/ClaroTv.png" alt="ClaroTv">
                </a>
                <a href="http://">
